...
define p = Character("Protagonist", color="#32a852", window_background=Image("gui/textbox_player.png", xalign=0.5, yalign=1.0))
define Poppie = Character("Poppie", color="#f0b5d2", window_background=Image("gui/textbox_poppie.png", xalign=0.5, yalign=1.0))
define g = Character("Girl", color="#f0b5d2", window_background=Image("gui/textbox_poppie.png", xalign=0.5, yalign=1.0))
